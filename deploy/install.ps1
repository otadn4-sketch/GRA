...
Write-Host "3) Run deploy\start-background.ps1 (recommended) or deploy\start.ps1, then open http://localhost:8000/login."
Write-Host "   Live ZIP updates need start-background.ps1 or deploy\register-task.ps1 so the service restarts itself."
