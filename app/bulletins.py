...
EDITORIAL_SPEAKER_PROMPT_VERSION = "garaye-speaker-summaries-v1"
EDITORIAL_EVENT_PROMPT_VERSION = "garaye-event-summaries-v1"
HIGH_ATTENTION_PROMPT_VERSION = "garaye-high-attention-v1"
...
این خلاصه را از زبان خود گوینده بنویس؛ به‌گونه‌ای که انگار خود او در حال بیان سخنانش است.
با توجه به متن، از لحن اول‌شخص مفرد یا جمع، مانند «من» یا «ما»، استفاده کن.
...
1. تیتر:
- کوتاه، روشن، خبری و جذاب باشد و موضوع اصلی و جهت اظهارنظر یا واکنش‌ها را منعکس کند.
- در صورت محوری بودن یک شخص، نام او را در تیتر بیاور؛ در غیر این صورت محور موضوع مشترک یا تقابل دیدگاه‌ها را بنویس.
- مبهم، هیجانی، جانبدارانه یا کلیک‌محور نباشد و ترجیحاً ۷ تا ۱۵ کلمه باشد.
